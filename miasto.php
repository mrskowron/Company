...
<a href="dodaj/dodajmiasto.php" type="button" class="btn btn-primary">Dodaj nowy rekord</a>
<?php
	require_once('connect.php');
	$mysqli->query("SET NAMES 'utf8'");
	if($rezultat = $mysqli->query("SELECT * FROM miasto "))
	{
		if($rezultat->num_rows>0)
		{
			...
			{
				echo "<tr>";
					echo "<td>".$wiersz->idMiasto."</td>";
					echo "<td>".$wiersz->Nazwa."</td>";
					echo "<td><a type='button' class='btn btn-danger' href='usun/usunmiasto.php?id=".$wiersz->idMiasto."'>Usuń</a></td>";
				echo "</tr>";
			}
			echo "</table>";
		}
